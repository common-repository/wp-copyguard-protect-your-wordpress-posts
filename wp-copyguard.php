<?php
/*
Plugin Name: WP-CopyGuard[Protect your wordpress posts]
Plugin URI: http://www.iamshekhar.co.cc/wp-copyguard/
Description: This plug-in will protect your blog posts,pages and content from being copied to other blogs.. A simple plug-in developed to stop the Copy cats and developed by Shekhar
Version: 1.9
Author: Shekhar Saxena
Author URI: http://www.iamshekhar.co.cc/
*/

/*
Copyright 2009  Shekhar Saxena, IN  (http://www.iamshekhar.co.cc/)
...
function CopyProtect_options_page()
{
	...
	?>
	<div class="wrap">
	<h1>WP-CopyGuard</h1> ver. 1.9
	| <a href="http://www.iamshekhar.co.cc/wp-copyguard" target="_blank" title="Visit homepage of wordpress plugin WP-CopyGuard">Visit Plugin page</a> | <a href="http://www.thechetan.com/wp-copyprotect/#donate" target="_blank" title="Donate some amount to WP-CopyGuard plugin developer to help him to develope more such plugins">Donate</a> | <a href="http://www.iamshekhar.co.cc/wp-copyguard" target="_blank" title="Few power donors,special thanks to them">Power Donors</a> | 
	...
	<form method="post" id="CopyProtect_options">
		...
		<table class="form-table">
			...
			<tr valign="top"> 
				...
				check to activate. <a href="http://www.iamshekhar.co.cc/wp-copyguard" target="_blank">Not working ?</a>
				</td> 
			</tr>
...
Most copy cats use your blogs <a href="/feed/" target="_blank">RSS feeds</a> to steal the content. Always select "Summary" at "For each article in a feed, show" in Wordpress admin panel "<a href="options-reading.php">Reading Settings</a>" so that even if someone try to copy your content from feeds he/she can not copy the whole post.
        ...
        <td>
		<h3>Whats next ?</h3>
		<p>Why don't you <a href="/wp-admin/post-new.php">write a post</a> about <a href="http://www.iamshekhar.co.cc/wp-copyguard" target="_blank">WP-CopyGuard</a> ?</p>
		<h3>Problems, Questions, Suggestions ?</h3>
		<p>Catch me on <a href="http://www.iamshekhar.co.cc/wp-copyguard" target="_blank">WP-CopyGuard Homepage</a></p>
        </td>
        </tr>
		</table>
		<h3>Thank you</h3>
		Plug in developed by <a href="http://www.iamshekhar.co.cc/" target="_blank">IamShekhar</a>. <br />
		<small>Follow me on Twitter <a href="http://twitter.com/devilslab" target="_blank">@devilslab</a></small>
		</fieldset>
	</form>
	</table>
	</div>
